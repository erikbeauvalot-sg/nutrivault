...
import { pushCtaClick, pushSocialClick, pushFormSubmit, pushSectionNavigate } from '../services/gtmService';
...
const MarionDietPage = () => {
  ...
  // SEO - Title management (meta tags, OG, JSON-LD are in index.html for pre-rendering)
  useEffect(() => {
    ...
    <div style={{ fontFamily: "'Playfair Display', Georgia, serif", color: colors.text, overflowX: 'hidden' }}>
      ...
      <nav style={{
        ...
        <div className="desktop-social" style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
          <a href="https://www.instagram.com/marion_dieteticienne/" target="_blank" rel="noopener noreferrer" onClick={() => pushSocialClick('instagram', 'https://www.instagram.com/marion_dieteticienne/')} style={{ color: colors.forest, transition: 'color 0.3s', display: 'flex', alignItems: 'center' }} onMouseOver={(e) => e.currentTarget.style.color = colors.wine} onMouseOut={(e) => e.currentTarget.style.color = colors.forest}>
          ...
          <a href="https://www.linkedin.com/in/marion-beauvalot/" target="_blank" rel="noopener noreferrer" onClick={() => pushSocialClick('linkedin', 'https://www.linkedin.com/in/marion-beauvalot/')} style={{ color: colors.forest, transition: 'color 0.3s', display: 'flex', alignItems: 'center' }} onMouseOver={(e) => e.currentTarget.style.color = colors.wine} onMouseOut={(e) => e.currentTarget.style.color = colors.forest}>
      ...
      {mobileMenuOpen && (
        ...
        >
          ...
          <div style={{ display: 'flex', gap: '1.5rem', padding: '1rem 2rem', justifyContent: 'center' }}>
            <a href="https://www.instagram.com/marion_dieteticienne/" target="_blank" rel="noopener noreferrer" onClick={() => pushSocialClick('instagram', 'https://www.instagram.com/marion_dieteticienne/')} style={{ color: colors.forest }}>
            ...
            <a href="https://www.linkedin.com/in/marion-beauvalot/" target="_blank" rel="noopener noreferrer" onClick={() => pushSocialClick('linkedin', 'https://www.linkedin.com/in/marion-beauvalot/')} style={{ color: colors.forest }}>
        ...
        <div className="hero-content" style={{
          ...
          <div className="hero-text" style={{ flex: '1', minWidth: '300px', maxWidth: '580px' }}>
            ...
            <a
              ...
              onClick={() => pushCtaClick('doctolib_hero', 'https://www.doctolib.fr/dieteticien/suresnes/marion-beauvalot')}
              style={{
                display: 'inline-flex',
                alignItems: 'center',
                gap: '0.5rem',
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div style={{ textAlign: 'center' }}>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              onClick={() => pushCtaClick('doctolib_services', 'https://www.doctolib.fr/dieteticien/suresnes/marion-beauvalot')}
              style={{
                display: 'inline-flex',
                alignItems: 'center',
                gap: '0.5rem',
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div style={{ textAlign: 'center' }}>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              onClick={() => pushCtaClick('doctolib_ateliers', 'https://www.doctolib.fr/dieteticien/suresnes/marion-beauvalot')}
              style={{
                display: 'inline-flex',
                alignItems: 'center',
                gap: '0.5rem',
        ...
        <div style={{
          ...
          <div style={{ flex: '1', minWidth: '280px', maxWidth: '350px' }}>
            ...
            <div style={{ display: 'flex', gap: '1rem' }}>
              <a href="https://www.instagram.com/marion_dieteticienne/" target="_blank" rel="noopener noreferrer" onClick={() => pushSocialClick('instagram', 'https://www.instagram.com/marion_dieteticienne/')} style={{ color: 'white', opacity: 0.8, transition: 'opacity 0.3s' }} onMouseOver={(e) => e.currentTarget.style.opacity = 1} onMouseOut={(e) => e.currentTarget.style.opacity = 0.8}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"/></svg>
              </a>
              <a href="https://www.linkedin.com/in/marion-beauvalot/" target="_blank" rel="noopener noreferrer" onClick={() => pushSocialClick('linkedin', 'https://www.linkedin.com/in/marion-beauvalot/')} style={{ color: 'white', opacity: 0.8, transition: 'opacity 0.3s' }} onMouseOver={(e) => e.currentTarget.style.opacity = 1} onMouseOut={(e) => e.currentTarget.style.opacity = 0.8}>
          ...
          <div style={{ flex: '1', minWidth: '280px', maxWidth: '300px' }}>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              onClick={() => pushCtaClick('doctolib_contact', 'https://www.doctolib.fr/dieteticien/suresnes/marion-beauvalot')}
              style={{
                display: 'inline-flex',
                alignItems: 'center',
                gap: '0.5rem',
