 ...
 * Full page for editing existing patients with organized form sections
 */
...
const EditPatientPage = () => {
  ...
  const fetchPatientData = async () => {
    try {
      ...
      setFormData({
        ...
        nutritional_goals: patientData.nutritional_goals || '',
        exercise_habits: patientData.exercise_habits || '',
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await api.put(`/api/patients/${id}`, submitData);
