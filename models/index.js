...
db.SidebarCategory = require('./SidebarCategory')(sequelize, DataTypes);
db.SidebarSection = require('./SidebarSection')(sequelize, DataTypes);
...
// PatientObjective associations
db.PatientObjective.belongsTo(db.Patient, { foreignKey: 'patient_id', as: 'patient' });
