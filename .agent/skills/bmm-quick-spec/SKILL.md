...
## Configuration
- **main_config**: {skill-root}/_config/bmm.yaml
- **advanced_elicitation**: {skill-root}/core-advanced-elicitation/SKILL.md
- **party_mode_exec**: {skill-root}/core-party-mode/SKILL.md
- **quick_dev_workflow**: {skill-root}/bmm-quick-dev/SKILL.md

## When to Use
This workflow can be run standalone and is designed for: conversational spec engineering - ask questions, investigate code, produce implementation-ready tech-spec.
...
- [step-01-understand.md](steps/step-01-understand.md)
- [step-02-investigate.md](steps/step-02-investigate.md)
- [step-03-generate.md](steps/step-03-generate.md)
- [step-04-review.md](steps/step-04-review.md)