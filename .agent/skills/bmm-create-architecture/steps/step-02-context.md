...
- Execute {skill-root}/core-advanced-elicitation/SKILL.md with the current context analysis
...
- Execute {skill-root}/core-party-mode/SKILL.md with the current project context
