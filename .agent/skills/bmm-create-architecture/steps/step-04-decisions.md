...
- Execute {skill-root}/core-advanced-elicitation/SKILL.md with specific decision categories
...
- Execute {skill-root}/core-party-mode/SKILL.md with architectural decisions context
