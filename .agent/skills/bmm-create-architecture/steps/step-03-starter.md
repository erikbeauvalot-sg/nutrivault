...
- Execute {skill-root}/core-advanced-elicitation/SKILL.md with current starter analysis
...
- Execute {skill-root}/core-party-mode/SKILL.md with starter evaluation context
