...
- Execute {skill-root}/core-advanced-elicitation/SKILL.md with current project structure
...
- Execute {skill-root}/core-party-mode/SKILL.md with project structure context
