...
- When 'A' selected: Execute {skill-root}/core-advanced-elicitation/SKILL.md
- When 'P' selected: Execute {skill-root}/core-party-mode/SKILL.md
...
- Execute {skill-root}/core-advanced-elicitation/SKILL.md with the current responsive/accessibility content
...
- Execute {skill-root}/core-party-mode/SKILL.md with the current responsive/accessibility strategy
