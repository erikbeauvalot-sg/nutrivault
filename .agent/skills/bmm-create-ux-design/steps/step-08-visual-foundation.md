...
- Execute {skill-root}/core-advanced-elicitation/SKILL.md with the current visual foundation content
...
- Execute {skill-root}/core-party-mode/SKILL.md with the current visual foundation
