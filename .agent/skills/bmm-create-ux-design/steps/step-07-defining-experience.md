...
- Execute {skill-root}/core-advanced-elicitation/SKILL.md with the current defining experience content
...
- Execute {skill-root}/core-party-mode/SKILL.md with the current defining experience
