...
- Execute {skill-root}/core-advanced-elicitation/SKILL.md with the current user journey content
...
- Execute {skill-root}/core-party-mode/SKILL.md with the current user journeys
