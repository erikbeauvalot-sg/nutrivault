...
- Execute {skill-root}/core-advanced-elicitation/SKILL.md with the current component strategy content
...
- Execute {skill-root}/core-party-mode/SKILL.md with the current component strategy
