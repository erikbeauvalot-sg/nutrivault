...
## When to Use
This workflow can be run standalone and is designed for: orchestrates group discussions between all installed bmad agents, enabling natural multi-agent conversations
...
- Agent manifest path: `{skill-root}/agent-manifest.csv`

##### Paths

- `installed_path` = `{skill-root}/core-party-mode`
- `agent_manifest_path` = `{skill-root}/agent-manifest.csv`
...
- [step-01-agent-loading.md](steps/step-01-agent-loading.md)
- [step-02-discussion-orchestration.md](steps/step-02-discussion-orchestration.md)
- [step-03-graceful-exit.md](steps/step-03-graceful-exit.md)