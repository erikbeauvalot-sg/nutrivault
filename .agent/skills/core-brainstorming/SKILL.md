...
## When to Use
This workflow can be run standalone and is designed for: facilitate interactive brainstorming sessions using diverse creative techniques and ideation methods
...
Load config from `{skill-root}/_config/core.yaml` and resolve:
...
- `installed_path` = `{skill-root}/core-brainstorming`
- `template_path` = `{installed_path}/template.md`
- `brain_techniques_path` = `{installed_path}/brain-methods.csv`
- `default_output_file` = `{output_folder}/analysis/brainstorming-session-{{date}}.md`
- `context_file` = Optional context file path from workflow invocation for project-specific guidance
- `advancedElicitationTask` = `{skill-root}/core-advanced-elicitation/SKILL.md`
...
### Methods Reference
- [brain-methods.csv](brain-methods.csv) - 61 techniques/methods available
  - Columns: `category,technique_name,description`

### Workflow Step Files

This workflow uses 8 micro-step files for disciplined execution:
- [step-01-session-setup.md](steps/step-01-session-setup.md)
- [step-01b-continue.md](steps/step-01b-continue.md)
- [step-02a-user-selected.md](steps/step-02a-user-selected.md)
- [step-02b-ai-recommended.md](steps/step-02b-ai-recommended.md)
- [step-02c-random-selection.md](steps/step-02c-random-selection.md)
- [step-02d-progressive-flow.md](steps/step-02d-progressive-flow.md)
- [step-03-technique-execution.md](steps/step-03-technique-execution.md)
- [step-04-idea-organization.md](steps/step-04-idea-organization.md)
