...
<critical>The workflow execution engine is governed by: {skill-root}/core-tasks/SKILL.md</critical>
<critical>You MUST have already loaded and processed: {skill-root}/bmm-workflow-status/SKILL.md</critical>
...
<check if="no status file found">
  ...
  <check if="response == y OR response == yes">
    ...
    <invoke-workflow path="{skill-root}/bmm-workflow-init/SKILL.md"></invoke-workflow>
