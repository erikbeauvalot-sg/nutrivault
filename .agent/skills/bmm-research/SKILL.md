...
## When to Use
This workflow can be run standalone and is designed for: conduct comprehensive research across multiple domains using current web data and verified sources - market, technical, domain and other research types.
...
- `installed_path` = `{skill-root}/bmm-research`
