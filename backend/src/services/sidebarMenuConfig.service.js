...
const DEFAULT_ITEMS = [
  ...
  { item_key: 'meal-plans',        section: 'main',     display_order: 8,  allowed_roles: ['ADMIN','DIETITIAN','ASSISTANT','VIEWER'], category_key: 'nutrition' },
  { item_key: 'campaigns',         section: 'main',     display_order: 9,  allowed_roles: ['ADMIN','DIETITIAN','ASSISTANT','VIEWER'], category_key: 'communication' },
  { item_key: 'messages',          section: 'main',     display_order: 10, allowed_roles: ['ADMIN','DIETITIAN','ASSISTANT','VIEWER'], category_key: 'communication' },
  { item_key: 'billing',           section: 'main',     display_order: 11, allowed_roles: ['ADMIN','DIETITIAN','ASSISTANT','VIEWER'], category_key: 'finance' },
  { item_key: 'quotes',            section: 'main',     display_order: 12, allowed_roles: ['ADMIN','DIETITIAN','ASSISTANT','VIEWER'], category_key: 'finance' },
  { item_key: 'finance',           section: 'main',     display_order: 13, allowed_roles: ['ADMIN','DIETITIAN','ASSISTANT','VIEWER'], category_key: 'finance' },
  { item_key: 'documents',         section: 'main',     display_order: 14, allowed_roles: ['ADMIN','DIETITIAN','ASSISTANT','VIEWER'], category_key: 'data' },
  { item_key: 'analytics',         section: 'main',     display_order: 15, allowed_roles: ['ADMIN','DIETITIAN','ASSISTANT','VIEWER'], category_key: 'data' },
  { item_key: 'users',             section: 'main',     display_order: 16, allowed_roles: ['ADMIN'],                                 category_key: 'admin' },
  // Settings section
