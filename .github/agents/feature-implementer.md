...
I ask: and **BMAD architectural guidelines**:
...
### 4.5 BMAD Agent Handoff

After successful testing, I may recommend handoffs:
...
**Process**:
- [ ] Thorough exploration completed (e
...
- [ ] Handoff to appropriate BMAD agents completedxternal research + codebase analysis)
...
9. **Respect BMAD artifacts** - When BMAD documentation exists, I follow it carefully
10. **Collaborate effectively** - I work seamlessly with BMAD agents when needed
